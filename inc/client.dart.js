...
$$.UsernameInput = {"": ["elem"],
 ...
 _onUsernameChange$0: function() {
  var t1 = $.isEmpty(this.elem.get$value()) !== true;
  var t2 = $.messageInput;
  if (t1)
    t2.enable$0();
  else
...
$$.ChatWindow = {"": ["elem"],
 ...
 _display$1: function(str) {
  var msg = $.Element_Element$html('<span>' + str + '</span>');
  var brElement = $.BRElement_BRElement();
  var t1 = this.elem.get$nodes();
  $.add$1(t1, msg);
  $.add$1(t1, brElement);
  msg.scrollIntoView$0();
}
};
...
$$.ChatConnection__init_scheduleReconnect = {"": ["this_3", "retrySeconds_2", "box_0"],
 "super": "Closure",
 call$0: function() {
  var t1 = $.chatWindow;
...
$$.ChatConnection__init_scheduleReconnect_anon = {"": ["this_5", "retrySeconds_4"],
 "super": "Closure",
 call$0: function() {
...
$$.ChatConnection__init_anon0 = {"": ["scheduleReconnect_6"],
 "super": "Closure",
 call$1: function(e) {
...
$$.ChatConnection__init_anon1 = {"": ["scheduleReconnect_7"],
 "super": "Closure",
 call$1: function(e) {
...
$$.ChatConnection__init_anon2 = {"": ["this_8"],
 "super": "Closure",
 call$1: function(e) {
...
$$.UsernameInput_bind_anon = {"": ["this_0"],
 "super": "Closure",
 call$1: function(e) {
...
$.main = function() {
  ...
  $.chatConnection = $.ChatConnection$($.websocketuri);
};
...
$.BRElement_BRElement = function() {
  return $._Elements_createBRElement();
};

$._Elements_createBRElement = function() {
  return $._document().$dom_createElement$1('br');
};
...
$.CTC44 = 'table';
$.CTC45 = 'audio';
$.CTC13 = new Isolate.$isolateProperties.ConstantMap(11, {'body': 'html', 'head': 'html', 'caption': 'table', 'td': 'tr', 'colgroup': 'table', 'col': 'colgroup', 'tr': 'tbody', 'tbody': 'table', 'tfoot': 'table', 'thead': 'table', 'track': 'audio'}, Isolate.$isolateProperties.CTC40);
$.CTC46 = '[-[\\]{}()*+?.,\\\\^$|#\\s]';
$.CTC16 = new Isolate.$isolateProperties.JSSyntaxRegExp('[-[\\]{}()*+?.,\\\\^$|#\\s]', false, false);
$.CTC47 = 'structured clone of Blob';
...
$.CTC49 = 'structured clone of RegExp';
...
$.websocketuri = 'ws://127.0.0.1:8080/ws';
...
$.$defineNativeClass('HTMLFieldSetElement', {"": ["disabled!", "elements?"],
 is$Element: function() { return true; }
});
